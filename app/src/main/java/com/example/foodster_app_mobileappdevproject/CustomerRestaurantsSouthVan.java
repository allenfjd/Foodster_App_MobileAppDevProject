...
public class CustomerRestaurantsSouthVan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customer_restaurants_south_van);

        dbh =new DataBaseHelper(this);

        Cursor c = dbh.viewDataFromRestaurantTableSouthVan();
        ...
        SimpleAdapter adapter = new SimpleAdapter(CustomerRestaurantsSouthVan.this,
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Intent i = new Intent(CustomerRestaurantsSouthVan.this,CustomerCreateOrder.class);
