...
public class CustomerRestaurantsSurrey extends AppCompatActivity {
    DataBaseHelper dbh;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_customer_restaurants_surrey);

        dbh =new DataBaseHelper(this);

        Cursor c = dbh.viewDataFromRestaurantTableSurrey();
        ...
        SimpleAdapter adapter = new SimpleAdapter(CustomerRestaurantsSurrey.this,
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Intent i = new Intent(CustomerRestaurantsSurrey.this,CustomerCreateOrder.class);
