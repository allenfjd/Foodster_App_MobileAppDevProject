...
public class CustomerRestaurantsNewWest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customer_restaurants);
        dbh =new DataBaseHelper(this);

        Cursor c = dbh.viewDataFromRestaurantTableNewWest();
