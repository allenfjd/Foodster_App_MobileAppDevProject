...
public class CustomerRestaurantsRichmond extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customer_restaurants_richmond);

        dbh =new DataBaseHelper(this);

        Cursor c = dbh.viewDataFromRestaurantTableRichmond();
        ...
        SimpleAdapter adapter = new SimpleAdapter(CustomerRestaurantsRichmond.this,
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Intent i = new Intent(CustomerRestaurantsRichmond.this,CustomerCreateOrder.class);
