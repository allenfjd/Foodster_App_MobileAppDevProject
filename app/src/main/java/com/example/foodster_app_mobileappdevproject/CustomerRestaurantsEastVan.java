...
public class CustomerRestaurantsEastVan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customer_restaurants_east_van);

        dbh =new DataBaseHelper(this);

        Cursor c = dbh.viewDataFromRestaurantTableEastVan();
        ...
        SimpleAdapter adapter = new SimpleAdapter(CustomerRestaurantsEastVan.this,
