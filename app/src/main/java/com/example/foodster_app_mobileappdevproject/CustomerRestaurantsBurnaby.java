...
public class CustomerRestaurantsBurnaby extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customer_restaurants_burnaby);

        dbh =new DataBaseHelper(this);

        Cursor c = dbh.viewDataFromRestaurantTableBurnaby();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                Intent i = new Intent(CustomerRestaurantsBurnaby.this,CustomerCreateOrder.class);
